...
class SalesforceClient(SalesforceBulk):
    ...
    @backoff.on_exception(backoff.expo, ConnectionError, max_tries=3, on_giveup=_giveup)
    ...
    @backoff.on_exception(backoff.expo, ConnectionError, max_tries=5, on_giveup=_giveup)
